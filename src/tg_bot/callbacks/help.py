...
@router.callback_query(F.data == CallbackDataEnum.HELP_MENU)
...
@router.callback_query(F.data == CallbackDataEnum.HELP_COMMANDS)
async def show_help_commands(call: CallbackQuery):
    await call.message.edit_text(  # type: ignore
        strings.COMMANDS_HELP,
        reply_markup=inline.get_inline_help(CallbackDataEnum.HELP_COMMANDS),
    )


@router.callback_query(F.data == CallbackDataEnum.HELP_SCALES)
async def show_help_scales(call: CallbackQuery):
    await call.message.edit_text(  # type: ignore
        strings.SCALES_HELP,
        reply_markup=inline.get_inline_help(CallbackDataEnum.HELP_SCALES),
    )


@router.callback_query(F.data == CallbackDataEnum.HELP_NOMENCLATURE)
async def show_help_nomenclature(call: CallbackQuery):
    await call.message.edit_text(  # type: ignore
        strings.NOMENCLATURE_HELP,
        reply_markup=inline.get_inline_help(CallbackDataEnum.HELP_NOMENCLATURE),
    )

...
def get_delta(bounds, parts_number) -> Tuple[Degrees, Degrees]:
    latitude_delta = (bounds[1].latitude - bounds[0].latitude) / parts_number
    longitude_delta = (bounds[1].longitude - bounds[0].longitude) / parts_number
